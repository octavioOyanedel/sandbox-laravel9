...
return [
    ...
    */
    ...
    'attributes' => [
        'n_distrito_id' => 'nombre',
        'n_provincia_id' => 'nombre',
        'n_comuna_id' => 'nombre',
        'n_sede_id' => 'nombre',
        'n_area_id' => 'nombre',
        'n_cargo_id' => 'nombre',
        'n_nacion_socio_id' => 'nombre',
        'n_parentesco_id' => 'nombre',
        'n_grado_id' => 'nombre',    
        'n_establecimiento_id' => 'nombre',
        'n_estado_estudio_id' => 'nombre',          
        'n_titulo_id' => 'nombre',
        'n_tasa_id' => 'cantidad',
        'n_concepto_id' => 'nombre',
        'numero' => 'número',
        ...
        'grado_id' => 'nivel académico',
        'estado_estudio_id' => 'estado estudio',
        'fecha_registro' => 'fecha de registro',
        'tipo_contable_id' => 'tipo de registro',
        'tipo_id' => 'tipo contable',
        'tipo' => 'tipo de cuenta',
        'cuenta_id' => 'cuenta',
        ...
        'fecha_nac_ini' => 'desde',
        'fecha_nac_fin' => 'hasta',
        'fecha_pucv_ini' => 'desde',
        'fecha_pucv_fin' => 'hasta',
        'fecha_sind1_ini' => 'desde',
        'fecha_sind1_fin' => 'hasta',
        'fecha_solicitud' => 'fecha de solicitud',
        'tipo_prestamo_id' => 'método de pago',
        'estado_prestamo_id' => 'estado de préstamo',
        'tasa_id' => 'interés',
        'distrito_id' => 'región',
        'provincia_id' => 'provincia',
        'sede_id' => 'sede',
        'abono_deposito' => 'monto',
